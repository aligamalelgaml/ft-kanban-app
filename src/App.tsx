...
function App() {
  ...
  /**
   * Closes the create new board dialog.
   */
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              {!open && (
                <>
                  <img
                    alt="kanban logo"
                    src={require("./assets/kanbanLogo.png")}
                    style={{ marginRight: mobileScreen ? "12px" : "" }}
                  />
                  {!mobileScreen && (
                    <>
                      <Typography
              ...
              {mobileScreen && (
                <>
                  {currentBoard.id === "" && (
                    <Typography ml={2}>Select a Board</Typography>
                  )}
                  <MobileDropdownMenu />
                </>
              )}
        ...
        >
          <div>
            ...
            >
              ...
              <Typography variant="h4" marginLeft={"15px"} fontWeight={"800"}>
                kanban
              </Typography>
            </DrawerHeader>
                ...
                <ListItem sx={{ width: "85%" }} key={board.id} disablePadding>
                  <ListItemButton
                    ...
                    sx={{
                      ...
                      pointerEvents:
                        board.id === currentBoard.id ? "none" : "auto",
                      "&:hover": {
                        // colors on hover
          ...
          <div>
            ...
            <Button
              ...
              sx={{
                ...
                paddingLeft: "2.1vw", // Add this line for left padding
                borderRadius: "0px 20px 20px 0px",
...
export default function ThemedApp() {
  const [mode, setMode] = useState<"light" | "dark">("light"); // State tracking light/dark mode.
  ...
  const theme = useMemo(() => createTheme(getDesignTokens(mode)), [mode]); // Used by theme provider to pass theme to child components.
